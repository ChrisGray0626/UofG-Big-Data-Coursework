...
public class DPHScorer {
    ...
    public static double getDPHScore(short termFrequencyInCurrentDocument, int totalTermFrequencyInCorpus,
        ...
        // calculate DPH score
        double DPHScore = norm * (termFrequencyInCurrentDocument * WeightingModelLibrary.log(
                (termFrequencyInCurrentDocument * averageDocumentLengthInCorpus / currentDocumentLength) *
